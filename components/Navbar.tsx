...
export default function Navbar() {
  ...
  return (
    ...
    {showAppBanner && <div className="flex h-[70px] items-center gap-3 bg-gradient-to-r from-[#fbe0e5] to-[#fff0d4] px-3 sm:hidden">
      ...
      <button type="button" aria-label="Dismiss app promotion" onClick={() => setShowAppBanner(false)} className="order-last flex h-5 w-5 shrink-0 items-center justify-center rounded-full text-[13px] text-neutral-500 hover:bg-white/60">x</button>
    </div>}
    <div className="border-b border-neutral-200 bg-white sm:hidden">
      ...
      <nav className="flex gap-4 overflow-x-auto px-4 pb-3 [scrollbar-width:none]"><Link href="/shop" className="flex w-14 shrink-0 flex-col items-center gap-1 text-[10px] font-semibold text-black"><span className="flex h-9 w-9 items-center justify-center overflow-hidden rounded-full bg-[#eeeae6]"><img src="https://images.unsplash.com/photo-1496747611176-843222e1e57c?auto=format&fit=crop&w=160&q=80" alt="" className="h-full w-full object-cover" /></span>New drop</Link><Link href="/shop?category=women" className="flex w-14 shrink-0 flex-col items-center gap-1 text-[10px] font-semibold text-neutral-600"><span className="flex h-9 w-9 items-center justify-center overflow-hidden rounded-full bg-[#eeeae6]"><img src="https://images.unsplash.com/photo-1483985988355-763728e1935b?auto=format&fit=crop&w=160&q=80" alt="" className="h-full w-full object-cover" /></span>Women</Link><Link href="/shop?category=men" className="flex w-14 shrink-0 flex-col items-center gap-1 text-[10px] font-semibold text-neutral-600"><span className="flex h-9 w-9 items-center justify-center overflow-hidden rounded-full bg-[#eeeae6]"><img src="https://images.unsplash.com/photo-1504593811423-6dd665756598?auto=format&fit=crop&w=160&q=80" alt="" className="h-full w-full object-cover" /></span>Men</Link><Link href="/shop?category=dresses" className="flex w-14 shrink-0 flex-col items-center gap-1 text-[10px] font-semibold text-neutral-600"><span className="flex h-9 w-9 items-center justify-center overflow-hidden rounded-full bg-[#eeeae6]"><img src="https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?auto=format&fit=crop&w=160&q=80" alt="" className="h-full w-full object-cover" /></span>Dresses</Link><Link href="/shop" className="flex w-14 shrink-0 flex-col items-center gap-1 text-[10px] font-semibold text-neutral-600"><span className="flex h-9 w-9 items-center justify-center overflow-hidden rounded-full bg-[#eeeae6]"><img src="https://images.unsplash.com/photo-1529139574466-a303027c1d8b?auto=format&fit=crop&w=160&q=80" alt="" className="h-full w-full object-cover" /></span>Trending</Link></nav>
    </div>
